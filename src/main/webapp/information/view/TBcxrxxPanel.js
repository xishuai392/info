 ...
 * @date 2014年11月19日
 */
Ext.define('component.information.view.TBcxrxxPanel', {
    extend : 'Ext.panel.Panel',
    layout : "border",
    requires : ['component.information.model.TBcxrxxModel', 'ZTEsoft.button.AddButton', 'ZTEsoft.button.EditButton', 'ZTEsoft.button.DelButton'],
    ...
    createStore : function() {
    	return Ext.create('component.information.store.TBcxrxxStore', {
    ...
    addBtnHandler : function() {
        var me = this;
        var win = Ext.create('component.information.view.TBcxrxxWin', {
