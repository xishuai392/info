...
Ext.onReady(function() {
    ...
    var thizAction = Ext.create("component.byTheQuery.action.TBcxrxxAction");

    // 数据源
    thizStore = Ext.create('component.byTheQuery.store.TBcxrxxStore', {
        ...
        onClickSave : function() {
            ...
            if (actionType == WEBConstants.ACTIONTYPE.NEW) {
                thizAction.addRecord(params, function(result) {
                    ...
                    var thizModel = Ext.create("component.byTheQuery.model.TBcxrxxModel");
